...
@admin.register(FormationPresentielle)
class FormationPresentiellAdmin(admin.ModelAdmin):
    list_display = ['titre', 'edition', 'domaine', 'est_gratuite', 'is_active', 'date_debut_inscription', 'date_fin_inscription']
    list_filter = ['domaine', 'est_gratuite', 'is_active']

@admin.register(DossierCandidature)
class DossierCandidatureAdmin(admin.ModelAdmin):
    list_display = ['nom_complet', 'formation', 'telephone', 'statut', 'created_at']
