...
from .views import SiteSettingsView, GaleriePhotoViewSet, ChangePasswordView, NewsletterView, NewsletterListView, AvisView, AvisAdminView, TemoignageViewSet, AdminUsersView, AuthMeView, reset_admin_password, ImageUploadView
...
urlpatterns = [
    ...
    path('avis/<int:pk>/',   AvisAdminView.as_view()),
